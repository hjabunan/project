...
<body>
    ...
    <div class="modal fade" id="AddModal" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="add.php" name="addform" method="POST" onsubmit="return adddata()">
    ...
    <div class="modal fade" id="UpdateModal" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update.php" name="updateform" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="AProfile">Update Profile</label>
                            <input type="file" name="AProfile" id="AProfile" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="mn-div">
        ...
        <div class="mn-wholebody">
            ...
            <br>
            <div class="mn-div-body" id='searchbody'>
                <div class="body-one">
                    <table class="table-show" name="table-show" id='table-show'>
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
